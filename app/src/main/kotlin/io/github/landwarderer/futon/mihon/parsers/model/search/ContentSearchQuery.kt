...
@Deprecated("Too complex. Use ContentListFilter instead")
@ConsistentCopyVisibility
public data class ContentSearchQuery private constructor(
	...
	public class Builder {
		...
		public constructor(query: ContentSearchQuery) : this() {
		...
		public fun build(): ContentSearchQuery {
			return ContentSearchQuery(deduplicateCriteria(criteria), order, offset, skipValidation)
		}
	...
	public companion object {
		...
		public val EMPTY: ContentSearchQuery = ContentSearchQuery(emptySet(), null, 0, false)
	}
}
