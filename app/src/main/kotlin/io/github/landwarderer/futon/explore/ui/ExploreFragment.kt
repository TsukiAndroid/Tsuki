...
import io.github.landwarderer.futon.core.ui.util.SpanSizeResolver
...
import io.github.landwarderer.futon.databinding.FragmentExploreBinding
import io.github.landwarderer.futon.explore.ui.adapter.ExploreAdapter
import io.github.landwarderer.futon.explore.ui.adapter.ExploreListEventListener
...
class ExploreFragment :
        ...
        override fun onViewBindingCreated(binding: FragmentExploreBinding, savedInstanceState: Bundle?) {
                ...
                addMenuProvider(ExploreMenuProvider(router, childFragmentManager) { showLanguageFilterDialog() })
