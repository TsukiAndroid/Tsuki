package io.github.landwarderer.futon.tracker.work
  ...
  class TrackerNotificationHelper @Inject constructor(
          ...
          suspend fun createNotification(manga: Manga, newChapters: List<MangaChapter>): NotificationInfo? {
                  ...
                  // Load cover once — reused for both largeIcon (collapsed) and BigPicture (expanded)
                  val coverBitmap: Bitmap? = coil.execute(
                  ...
                  val chapterLine = if (newChapters.size == 1) {
                          newChapters[0].getLocalizedTitle(applicationContext.resources)
                  } else {
                          summary
                  }
                  ...
                  val bigPictureStyle = NotificationCompat.BigPictureStyle()
                          ...
                          .bigLargeIcon(null as Bitmap?)  // hides largeIcon when notification is expanded
                          .setBigContentTitle(manga.title)
                          .setSummaryText(chapterLine)
          ...
          fun updateChannels() {
                  ...
                  val chaptersChannel = NotificationChannelCompat.Builder(CHANNEL_ID, NotificationManagerCompat.IMPORTANCE_DEFAULT)
                          ...
                          .build()
                  manager.createNotificationChannel(chaptersChannel)

                  val workerChannel = NotificationChannelCompat.Builder(WORKER_CHANNEL_ID, NotificationManagerCompat.IMPORTANCE_LOW)
          ...
          companion object {
                  ...
                  const val GROUP_NOTIFICATION_ID = 1
                  const val GROUP_NEW_CHAPTERS = "io.github.landwarderer.futon.NEW_CHAPTERS"
