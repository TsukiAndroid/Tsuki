package io.github.landwarderer.futon.mihon.parsers.network

import io.github.landwarderer.futon.mihon.parsers.InternalParsersApi
import io.github.landwarderer.futon.mihon.parsers.exception.AuthRequiredException
import io.github.landwarderer.futon.mihon.parsers.exception.GraphQLException
import io.github.landwarderer.futon.mihon.parsers.exception.NotFoundException
import io.github.landwarderer.futon.mihon.parsers.model.ContentSource
import io.github.landwarderer.futon.mihon.parsers.util.await
import io.github.landwarderer.futon.mihon.parsers.util.parseJson
        ...
        fun peekErrorBody(): String {
            return runCatching {
                ...
                val s = try {
                    ...
                    bytes.joinToString(limit = 64, truncated = "â€¦") { it.toUByte().toString() }
                }
                s
            }.getOrDefault("")
        }
