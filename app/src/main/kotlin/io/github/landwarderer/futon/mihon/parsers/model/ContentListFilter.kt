...
public data class ContentListFilter(
	@JvmField val query: String? = null,
	@JvmField val tags: Set<ContentTag> = emptySet(),
	@JvmField val tagsExclude: Set<ContentTag> = emptySet(),
	@JvmField val locale: Locale? = null,
	@JvmField val originalLocale: Locale? = null,
	@JvmField val states: Set<ContentState> = emptySet(),
	...
	public companion object {
		...
		@JvmStatic
		public val EMPTY: ContentListFilter = ContentListFilter()
	}

	internal class Builder {
		private var query: String? = null
		private val tags: MutableSet<ContentTag> = mutableSetOf()
		private val tagsExclude: MutableSet<ContentTag> = mutableSetOf()
		private var locale: Locale? = null
		private var originalLocale: Locale? = null
		private val states: MutableSet<ContentState> = mutableSetOf()
		...
		fun addTag(tag: ContentTag): Builder = apply { tags.add(tag) }
		fun addTags(tags: Collection<ContentTag>): Builder = apply { this.tags.addAll(tags) }
		fun excludeTag(tag: ContentTag): Builder = apply { tagsExclude.add(tag) }
		fun excludeTags(tags: Collection<ContentTag>): Builder = apply { this.tagsExclude.addAll(tags) }
		...
		fun addState(state: ContentState): Builder = apply { states.add(state) }
		fun addStates(states: Collection<ContentState>): Builder = apply { this.states.addAll(states) }
		...
		fun build(): ContentListFilter = ContentListFilter(
