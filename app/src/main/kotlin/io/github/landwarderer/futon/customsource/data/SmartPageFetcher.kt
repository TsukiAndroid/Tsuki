 ...
 *  - A manga detail page (href matching /manga/x, /series/x, /title/x, etc.)
 *  - A chapter page (href matching /chapter/x, /ch/x, /read/x, etc.)
 *
...
class SmartPageFetcher(private val context: Context? = null) {
    ...
    // Probe common manga-list paths via HEAD request
    ...
    // Scan homepage nav/header links for manga-related keywords
    ...
    // Find a manga detail page link inside the list-page HTML
    ...
    // Find a chapter link inside the detail-page HTML
