package io.github.landwarderer.futon.customsource.data
  ...
  class ComixToHtmlParser(
      ...
      fun getDetails(manga: Manga): Manga {
          ...
          return runCatching {
              ...
              val title = doc.selectFirst(
                  ".detail-info h1, .story-title, h1.title-detail, " +
                  ".series-title, .manga-title, h1[class*=title], .entry-title"
      ...
      private fun parseMangaListPage(doc: Document): List<Manga> {
          // Cascade of selectors from specific to general
          val items = doc.select(
              ...
              // Ultra-broad: any div/article with a manga-like class containing a link
          ...
          // Nuclear fallback: find all anchors with images that have plausible manga URLs
          return doc.select("a[href]").filter { a ->
              ...
              // Try to find title from nearby text or img alt
