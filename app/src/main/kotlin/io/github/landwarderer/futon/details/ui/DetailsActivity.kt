...
import io.github.landwarderer.futon.core.ui.image.TextDrawable
import io.github.landwarderer.futon.core.ui.image.TextViewTarget
import io.github.landwarderer.futon.core.ui.list.OnListItemClickListener
import io.github.landwarderer.futon.core.ui.sheet.BottomSheetCollapseCallback
...
import io.github.landwarderer.futon.core.util.LocaleUtils
...
import io.github.landwarderer.futon.core.util.ext.isTextTruncated
import io.github.landwarderer.futon.core.util.ext.joinToStringWithLimit
...
import io.github.landwarderer.futon.core.util.ext.parentView
...
import io.github.landwarderer.futon.databinding.ActivityDetailsBinding
import io.github.landwarderer.futon.databinding.LayoutDetailsTableBinding
...
import io.github.landwarderer.futon.details.ui.scrobbling.ScrobblingItemDecoration
import io.github.landwarderer.futon.details.ui.scrobbling.ScrollingInfoAdapter
import io.github.landwarderer.futon.download.ui.worker.DownloadStartedObserver
...
class DetailsActivity :
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
                ...
                // Apply user-defined cover background transparency
                val alphaFraction = settings.coverBackgroundAlpha / 100f
                viewBinding.imageViewBlurBackground?.alpha = alphaFraction
                viewBinding.imageViewBlurBackground?.let { GlassEffectHelper.applyBlurBackground(it) }
