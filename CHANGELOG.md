...
- Add files via upload (8891d71)
- chore: update total downloads badge [skip ci] (691af05)
...
- Add files via upload (92fc8d8)
- chore: update total downloads badge [skip ci] (10e2d4f)
- chore: archive alpha-latest downloads (+4) [skip ci] (106e636)
...
- Modify Weblate configuration for translations (795a188)
...
- docs: record Android plugin CI lessons (cda47cc)
...
- Delete .github/workflows/update-parsers.yml (e992e8c)
...
- Add files via upload (baec6b8)
- Delete screenshots/screenshot_4.png (98c670a)
- Delete screenshots/screenshot_3.png (f071588)
- Delete screenshots/screenshot_2.png (66bf262)
...
- feat(universal-parser): wire Universal Source button click in AddCustomSourceSheet (ebf03f7)
- feat(universal-parser): wire Universal Source button in AddCustomSourceSheet (231c3db)
...
- fix: remove manual Accept-Encoding header so OkHttp auto-decompresses gzip responses (518a458)
- fix: remove manual Accept-Encoding — OkHttp only auto-decompresses when it sets the header itself (107318e)
- fix: rewrite manhwaread.js with pure ASCII comments + safe QuickJS regex patterns (2259a07)
...
- docs: update replit.md with project overview and manhwaread fixes (19e9db0)
- fix(madara): parse chapterData JS variable for manhwaread page images (0adc1ad)
- fix(madara): parse chapterData JS for manhwaread page images; add manga-item__link selector (2b84a22)
- feat(crash): register CrashReportActivity in AndroidManifest (21cf1d2)
- feat(crash): add string resources for CrashReportActivity (b7d5071)
- feat(crash): install CrashHandler in BaseApp.onCreate() (90b939c)
- feat(crash): add global CrashHandler (1ff381e)
- feat(crash): add CrashReportActivity with Copy + Close buttons (42462ef)
- feat(crash): add layout for CrashReportActivity (9f4acd7)
...
- fix(madara): add /ajax/chapters/ endpoint + broader description selectors (7b9babd)
- test: add BuiltinParserSanityTest for parser registry integrity (bbee071)
- ci: add daily parser-version-bump workflow for kotatsu-parsers-redo (4d5f69e)
...
- fix(ci): revert accidental auto-download=false in gradle.properties (bba9949)
...
- feat: Change Parser sheet + sectioned parser picker in Add/Edit sheets (b9c2802)
- Update generate-parser.js (bca7f1e)


## Alpha 1.469 (Build [#132](https://github.com/Space4414/Tsuki/actions/runs/25774595469))

_2026-05-13 02:31 UTC_

- Update generate-parser.js (bca7f1e)
- Update generate-parser.js (400f6de)


## Alpha 1.467 (Build [#131](https://github.com/Space4414/Tsuki/actions/runs/25774018339))

_2026-05-13 02:13 UTC_
...
- Update generate-parser.js (4a9c6ce)
- Update generate-parser.js (0e71514)


## Alpha 1.456 (Build [#125](https://github.com/Space4414/Tsuki/actions/runs/25768786243))

_2026-05-12 23:42 UTC_
...
- Update index.html (28f6d8a)
- Update index.html (9030165)


## Alpha 1.442 (Build [#117](https://github.com/Space4414/Tsuki/actions/runs/25724640288))

_2026-05-12 09:05 UTC_
