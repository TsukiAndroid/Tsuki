...
- New About section: rewritten copy, Space4414 source-code link, Arsveiled credit
...
- Removed unused agent / docs files left over from earlier AI-assisted iterations
