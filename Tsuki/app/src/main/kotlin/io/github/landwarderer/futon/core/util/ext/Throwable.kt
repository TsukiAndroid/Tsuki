...
import io.github.landwarderer.futon.core.exceptions.BadBackupFormatException
import io.github.landwarderer.futon.core.exceptions.CaughtException
...
import io.github.landwarderer.futon.core.exceptions.IncompatiblePluginException
...
import io.github.landwarderer.futon.core.exceptions.UnsupportedFileException
import io.github.landwarderer.futon.core.exceptions.UnsupportedSourceException
import io.github.landwarderer.futon.core.exceptions.WrapperIOException
import io.github.landwarderer.futon.core.exceptions.WrongPasswordException
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/io.github.landwarderer.futon/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/io.github.landwarderer.futon/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
